...
function DashboardPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardPage.useEffect": ()=>{
            const getUsers = {
                "DashboardPage.useEffect.getUsers": async ()=>{
                    const fetchData = await fetch("https://dummyjson.com/users?limit=10&skip=0");
                    const getUsers = await fetchData.json();
                    setAllUsers(getUsers);
                }
            }["DashboardPage.useEffect.getUsers"];
            getUsers();
        }
    }["DashboardPage.useEffect"]);
...
_s(DashboardPage, "/Pv1A6C/c1Xm+qTo6FlqI4li6xg=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=_f38d4e16._.js.map